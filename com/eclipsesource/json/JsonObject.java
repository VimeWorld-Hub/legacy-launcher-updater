...
public class JsonObject extends JsonValue implements Iterable<JsonObject.Member>
{
    ...
    private JsonObject(final JsonObject object, final boolean unmodifiable) {
        ...
        if (unmodifiable) {
            this.names = Collections.unmodifiableList((List<? extends String>)object.names);
            this.values = Collections.unmodifiableList((List<? extends JsonValue>)object.values);
        }
        else {
    ...
    public List<String> names() {
        return Collections.unmodifiableList((List<? extends String>)this.names);
    }
